...
stream_truststore_password_file="${secret_root}/STREAM_TRUSTSTORE_PASSWORD"
stream_keystore_password_file="${secret_root}/STREAM_KEYSTORE_PASSWORD"
stream_jaas_config_file="${secret_root}/STREAM_JAAS_CONFIG"
...
if [ -e "$stream_keystore_password_file" ]; then
   export SECRET_STREAM_KEYSTORE_PASSWORD=$(<${stream_keystore_password_file})
else
   export SECRET_STREAM_KEYSTORE_PASSWORD=${STREAM_KEYSTORE_PASSWORD}
fi
